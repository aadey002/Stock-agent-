...
function aiAnalyzeBestOptions() {
    ...
    document.getElementById('aiAnalysisText').innerHTML = 
        ...
        <strong>✅ Recommended Trade:</strong> Buy  at confluence_agent.yml{best.strike} strike<br>
        <strong>💰 Cost:</strong> confluence_agent.yml{best.premium} per share (confluence_agent.yml{(parseFloat(best.premium) * 100).toFixed(0)} per contract)<br>
        <strong>🎯 Target Price:</strong> confluence_agent.yml{expectedTarget}<br>
